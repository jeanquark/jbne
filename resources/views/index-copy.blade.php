        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a class="page-scroll" href="#about">Historique</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="#team">Membres</a>
                    </li>
                    <li>
                    ...
                    @if (Auth::check())
                        <li>
                            <a class="page-scroll" href="back/index"><i class="fa fa-black-tie"> Admin</i></a>
                        </li>
                        <li>
    ...
    <header>
        <div class="container">
            <div class="intro-text">
                ...
                <div class="intro-heading">Jeune Barreau neuchâtelois</div>
        ...
        <div class="container">
            ...
            <div class="row text-center">
                ...
                <div class="col-md-4">
                    ...
                    <p class="text-muted">Le jeune barreau neuchâtelois est une association de droit privé à but non lucratif. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Minima maxime quam architecto quo inventore harum ex magni, dicta impedit.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="portfolio" class="bg-light-gray">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <a href="#loginModal" class="portfolio-link" data-toggle="modal">
                        <div class="portfolio-hover">
                            <div class="portfolio-hover-content">
                                <i class="fa fa-plus fa-3x"></i>
                            </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-3 col-sm-6">
            <a href="#">
              <img class="img-fluid d-block mx-auto" src="images/logos/bcn.jpg" width="200" alt="">
            </a>
          </div>
          <div class="col-md-3 col-sm-6">
            <a href="#">
              <img class="img-fluid d-block mx-auto" src="images/logos/axa.jpg" width="200" alt="">
            </a>
          </div>
          <div class="col-md-3 col-sm-6">
            <a href="#">
              <img class="img-fluid d-block mx-auto" src="images/logos/tissot.jpg" width="200" alt="">
            </a>
          </div>
          <div class="col-md-3 col-sm-6">
            <a href="#">
              <img class="img-fluid d-block mx-auto" src="images/logos/walder.jpg" width="200" alt="">
            </a>
          </div>
        </div>
      </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                {{-- <div class="form-group">
                                    <input type="text" class="form-control" placeholder="Votre nom *" id="lastname" required data-validation-required-message="Please enter your name.">
                                ...
                                {{-- <div class="form-group">
                                    <input type="text" class="form-control" placeholder="Votre prénom *" id="firstname" required data-validation-required-message="Please enter your name.">
                                    <p class="help-block text-danger"></p>
                                </div>--}}
                            ...
                            <div class="col-lg-12 text-center">
                                ...
                                {!! Form::submit('Envoyer Message', array('class'=>'btn btn-xl', 'style' => '')) !!}
                            </div>
                        </div>
                    {{-- </form> --}}
                    {!! Form::close() !!}
