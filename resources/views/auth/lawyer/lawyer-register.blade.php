        ...
        <div class="row">
            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    <div class="panel-heading text-center"><img src="{{ asset('images/logo2.png') }}" width="30px" /> - JBNE Enregistrement des Avocats</div>
                    ...
                    <div class="panel-body">
                        ...
                        @endif
                        <span class="">Veuillez utiliser le formulaire ci-dessous pour vous enregistrer. Vous pourrez ensuite nous transmettre vos semaines de disponibilité dans le cadre de la permanence des avocats de la 1<sup>ère</sup> heure. En cas de problème ou de question, n'hésitez-pas à nous <a href="{{ route('home', '#contact') }}">contacter</a>.</span>
                        <br /><br />
                        {{-- <form class="form-horizontal" method="POST" action="{{ route('lawyer.register.submit') }}"> --}}
                        {!! Form::open(array('route' => 'lawyer.register.submit', 'method' => 'POST', 'class' => 'form-horizontal', 'id' => 'lawyer_registration')) !!}
                            ...
                            <div class="form-group{{ $errors->has('username') ? ' has-error' : '' }}">
                                <label for="username" class="col-md-4 control-label">Nom d'utilisateur<br><small>(Identifiant de connexion)</small></label>
                                <div class="col-md-6">
                                    <input id="username" type="username" class="form-control" name="username" value="{{ old('username') }}" placeholder="" autofocus>
                                </div>
                            </div>
                            ...
                            <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="email" type="email" class="form-control" name="email" value="{{ old('email') }}" placeholder="" autofocus>
                                </div>
                            </div>
                            ...
                            <div class="form-group{{ $errors->has('lastname') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="lastname" type="text" class="form-control" name="lastname" value="{{ old('lastname') }}" placeholder="" autofocus>
                                </div>
                            </div>
                            ...
                            <div class="form-group{{ $errors->has('firstname') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="firstname" type="text" class="form-control" name="firstname" value="{{ old('firstname') }}" placeholder="" autofocus>
                                </div>
                            </div>

                            <div class="form-group{{ $errors->has('phone_mobile') ? ' has-error' : '' }}">
                                <label for="phone_mobile" class="col-md-4 control-label">Numéro de permanence (numéro de tél. portable)</label>
                                <div class="col-md-6">
                                    <input id="phone_mobile" type="text" class="form-control" name="phone_mobile" value="{{ old('phone_mobile') }}" placeholder="(079)-987-65-43" autofocus>
                                </div>
                            </div>
                            ...
                            <div class="form-group{{ $errors->has('other_languages') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input type="checkbox" name="languages[]" id="french" value="français" autocomplete="off" disabled checked />
                                    <div class="btn-group">
                                    ...
                                    <input type="checkbox" name="languages[]" id="german" value="allemand" autocomplete="off" @if(is_array(old('languages')) && in_array('allemand', old('languages'))) checked @endif />
                                    <div class="btn-group">
                                    ...
                                    <input type="checkbox" name="languages[]" id="italian" value="italien" autocomplete="off" @if(is_array(old('languages')) && in_array('italien', old('languages'))) checked @endif/>
                                    <div class="btn-group">
                                    ...
                                    <input type="checkbox" name="languages[]" id="english" value="anglais" autocomplete="off" @if(is_array(old('languages')) && in_array('anglais', old('languages'))) checked @endif/>
                                    <div class="btn-group">
                                    ...
                                    <input type="checkbox" name="other_languages_check[]" id="other_languages" value="1" autocomplete="off" @if(is_array(old('other_languages_check')) && in_array(1, old('other_languages_check'))) checked @endif />
                                    <div class="btn-group {{ $errors->has('other_languages_input') ? ' has-error' : '' }}">
                                        <label for="other_languages" class="btn btn-default">
                                            ...
                                            <input id="other_languages_input" type="text" class="form-control" name="other_languages_input" value="{{ old('other_languages_input') }}" disabled autofocus>
                                        </label>
                                    </div>
                                </div>
                            </div><!-- ./form-group -->
                            ...
                            {{-- <div class="form-group{{ $errors->has('phone_office') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="phone_office" type="text" class="form-control" name="phone_office" value="{{ old('phone_office') }}" autofocus>
                                </div>
                            </div> --}}
                            ...
                            {{-- <div class="form-group{{ $errors->has('fax_office') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="fax_office" type="text" class="form-control" name="fax_office" value="{{ old('fax_office') }}" placeholder="(032)-987-65-43" autofocus>
                                </div>
                            </div> --}}
