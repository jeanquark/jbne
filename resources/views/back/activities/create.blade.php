...
@section('content')
    ...
    <div class="row clearfix">
        <div class="col-md-12">
            <div class="card">
                <br />
                <h3 class="text-center">Créer une nouvelle activité</h3>
                <h5 class="text-center">Les champs suivis d'un astérisque (*) sont obligatoires</h5>
                <br />
                <div class="body">
                    <div class="row clearfix">
                        <div class="">
                            {!! Form::open(array('route' => 'back.activities.store', 'method' => 'POST', 'files' => true, 'id' => 'create_activity')) !!}
                                ...
                                <div class="col-md-6 col-md-offset-3">
                                    {!! Form::label('file', 'Fichier en téléchargement:', array('class' => 'form-label')) !!} <i class="fa fa-exclamation-circle"> Taille max: 5MB, Type: PDF</i>
                                    {!! Form::file('file', ['class' => 'field', 'id' => 'file']) !!}
                                    <br /><br />
                                </div>
