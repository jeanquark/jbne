...
@section('content')
	<ol class="breadcrumb">
        <li>
            <i class="fa fa-wine-glass"></i>  <a href="{{ route('back.trainees.index') }}">Avocats-stagiaires</a>
        </li>
        <li class="active">
    ...
    <div class="row clearfix">
        <div class="col-md-12">
            <div class="card">
                <br />
                <h3 class="text-center">Editer ce contenu</h3>
                <br />
                <div class="body">
                    <div class="row clearfix">
                        <div class="">
                            {!! Form::model($trainee, array('route' => array('back.trainees.update', $trainee->id), 'method' => 'PUT', 'files' => true, 'id' => 'edit_activity')) !!}
                                ...
                                <div class="col-md-6 col-md-offset-3">
                                	<div class="col-md-6">
                                        @if ($trainee->image_path)
    	                                    ...
    	                                    {!! Form::image($trainee->image_path, 'image', ['class' => 'field', 'id' => 'image', 'width' => '100']) !!}
                                            <br />
                                            {!! Form::label('deleteImage', 'Supprimer image') !!}
                                            {!! Form::checkbox('deleteImage', true, null, ['class' => '']) !!}
                                        @endif
	                                </div>
