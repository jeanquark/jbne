...
class MemberResetPasswordNotification extends Notification
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
                    ...
                    ->action('Réinitialiser mot de passe', route('member.password.reset', $this->token))
                    ->line("Si vous n'avez pas effectué vous-même cette demande, aucune action n'est requise de votre part. Effacez simplement cet e-mail.");
    }
